...
const requestURL = 'https://api.openweathermap.org/data/2.5/weather?lat=42.05&lon=-111.25&units=imperial&APPID=a442aaa7bf1b55d1a3f7a66de5e262fe';
...
fetch(requestURL)
  ...
  .then((jsObject) => {
    ...
    // ---------------------------
    const forecastURL =
      'https://api.openweathermap.org/data/2.5/forecast?lat=42.05&lon=-111.25&appid=a442aaa7bf1b55d1a3f7a66de5e262fe&units=imperial';
    fetch(forecastURL)
      .then((response) => response.json())
      .then((fcinfo) => {
        console.log(fcinfo);
